    ...
    return (
        <div className="container text-center p-5">
            <section className="col">
                <header>
                    <h2><b>Get in Touch</b></h2><br></br>
                </header>
            </section>

            <section className="col">
                <form name="form" className='formContact' onSubmit={handleSubmit}>
                    <div className="mb-3">
                    ...
                    <input className="buttonSubmit" type="submit" id="submit" value="Submit" />
                    <input className="buttonReset" type="reset" value="Reset" onClick={() => setFormData({
                        fullname: '',
                        email: '',
                        phonenum: '',
                        messages: ''
            ...
            <section className="col p-5">
                ...
                <div className="grid-container-personal-info">
                    <div className="grid-item">Name: Aulia Syahnur | Email: saulia479@gmail.com</div>
                </div>
            </section>
        </div>
    );
